				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-signin" action="<c:url value='/service.do'/>"
							method="post">
							<input type="hidden" name="service" value="CriarUser"> <input
								type="hidden" name="id" value="${user.id}">
							<div style="margin-bottom: 25px" class="input-group">
								<span class="input-group-addon"> <i
									class="glyphicon glyphicon-user"></i>
								</span> <input name="nome" class="form-control" type="text"
									value="${user.nome}" autofocus="" required=""
									placeholder="Digite o nome">
							</div>
							<div style="margin-bottom: 25px" class="input-group">
								<span class="input-group-addon"> <i
									class="glyphicon glyphicon-knight"></i>
								</span> <input name="cpf" class="form-control" type="text"
									value="${user.cpf}" autofocus="" required=""
