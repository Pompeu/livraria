...
<nav class="role="navigation" class="navbar navbar-default navbar-fixed-top">
<div class="container-fluid">
	<div class="navbar-header">
		<a class="navbar-brand" href="<c:url value='/'/>"> <i class="glyphicon glyphicon-home"></i> Livraria</a>
	</div>
	<div>
		<ul class="nav navbar-nav">
			<li><a href="<c:url value='/service.do?service=FormUser'/>">
			 <i class="glyphicon glyphicon-thumbs-up"></i> Cadastrar</a></li>
			<li>
				<c:if test="${sessionScope.usuLogado == null}">
					<a href="<c:url value='/service.do?service=FormLogar'/>">
					 <i class="glyphicon glyphicon-ok"></i> Logar</a>
				</c:if>
			</li>
			<li>
				<c:if test="${sessionScope.usuLogado.nivel eq 'ADMIN'}">
					<a href="<c:url value='/service.do?service=FormLivro'/>">
					 <i class=""></i> Cadastrar
						Livros</a>
				</c:if>
			</li>
			...
			<li>
				<a href='<c:url value="crtl.do?crtl=CarrinhoCrtl"/>'><i class="glyphicon glyphicon-shopping-cart"></i>
				Carrinho</a>
			</li>
			<li>
				<c:if test="${sessionScope.usuLogado != null}">					
					<a href="<c:url value='/crtl.do?crtl=LogoutCrtl'/>">
						Ola Sr <span>${sessionScope.usuLogado.nome}</span>
